      ...
      if (event.type === 'message') {
        ...
        if (messageType === 'image') {
          ...
          try {
            ...
            console.error(error);
            await replyToLine(replyToken, "ระบบแอบงงงวย วิเคราะห์รูปภาพนี้ไม่ได้เลยค้าบ ลองส่งรูปมาให้ AI ดูใหม่อีกรอบน๊าา 📸✨");
          }
          ...
          if (text.startsWith('เพิ่ม ') || text.startsWith('ถามแคล ')) {
            ...
            try {
              ...
              console.error(error);
              await replyToLine(replyToken, "โอ๊ะโอ! 😵‍💫 AI หาข้อมูลโภชนาการของเมนูนี้ไม่เจอเลยค้าบ ลองพิมพ์ชื่อเมนูแบบอื่นดูอีกทีน๊า 🧐");
            }
          }
        }
      }

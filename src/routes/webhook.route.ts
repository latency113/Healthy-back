...
import { downloadLineMessageContent, replyToLine, showLoadingAnimation } from '../services/line.service';
        ...
        if (messageType === 'image') {
          ...
          try {
            ...
            await replyToLine(replyToken, [
              "กำลังวิเคราะห์รูปภาพอาหารให้อยู่น้าา รอแป๊บนึงนะค้าบ... 🍳✨",
              summaryMessage
            ]);
            ...
            await replyToLine(replyToken, [
              "กำลังวิเคราะห์รูปภาพอาหารให้อยู่น้าา รอแป๊บนึงนะค้าบ... 🍳✨",
              "ระบบแอบงงงวย วิเคราะห์รูปภาพนี้ไม่ได้เลยค้าบ ลองส่งรูปมาให้ AI ดูใหม่อีกรอบน๊าา 📸✨"
            ]);
          }
          ...
          if (text.startsWith('เพิ่ม ') || text.startsWith('ถามแคล ')) {
            ...
            try {
              ...
              await replyToLine(replyToken, [
                `กำลังค้นหาข้อมูลของเมนู "${foodQuery}" ให้อยู่น้าา รอแป๊บนึงนะค้าบ... 🔍✨`,
                summaryMessage
              ]);
              ...
              await replyToLine(replyToken, [
                `กำลังค้นหาข้อมูลของเมนู "${foodQuery}" ให้อยู่น้าา รอแป๊บนึงนะค้าบ... 🔍✨`,
                "โอ๊ะโอ! 😵‍💫 AI หาข้อมูลโภชนาการของเมนูนี้ไม่เจอเลยค้าบ ลองพิมพ์ชื่อเมนูแบบอื่นดูอีกทีน๊า 🧐"
              ]);
            }
          }
        }
